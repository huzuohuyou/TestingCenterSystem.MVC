...
namespace Elight.Web.Areas.TestCenterSystem.Controllers
{
    ...
    {
        //public IAddCommonItemService<TC_SD_ITEM_INFO> _itemService = AutoFacConfig.Resolve<IAddCommonItemService<TC_SD_ITEM_INFO>>();
        ...
        //public IItemDepService<TC_SD_ITEM_DEP> _itemDepService = AutoFacConfig.Resolve<IItemDepService<TC_SD_ITEM_DEP>>();
